  ...
  return (
    <div className="w-full flex justify-center items-center flex-col">
      ...
      <div className="w-main flex justify-center mt-5">
        <div className="w-[77%]">
          <div className="w-[100%]">
            <div className="">
              <div className=" text-[15px] ">
                <div className="w-full flex">
                  ...
                  <div className="w-[55%] flex  flex-col ml-5">
                    <div className="w-[80%] mt-2 text-[15px] font-semibold">
                ...
                <div className="w-full flex">
                  ...
                  <div className="w-[55%] flex  flex-col ml-5">
                    ...
                    <span className="text-[13px] mt-2 w-[80%]">
                      ...
                      odit aut fugit, sed quia dolore consequuntur magni dolores
                      eos...
                    </span>
                  </div>
                </div>
              ...
              <div className=" text-[15px] mt-5 mb-10">
                <div className="w-full flex">
                  <div className="w-[45%]">
                    <img
                      className="h-[250px] w-full object-cover"
        ...
        <div className="w-[23%] border h-[380px]">
